...
sub resource_classes {
    ...
    return {
        ...
        'RegBlast'    => { 'LSF' => [ '-C0 -M'.$self->o('blast_gigs').'000 -q normal -R"select[mem>'.$self->o('blast_gigs').'000] rusage[mem='.$self->o('blast_gigs').'000]"', '-lifespan 360' ]  },
        'LongBlastHM'  => { 'LSF' => [ '-C0 -M'.$self->o('blast_hm_gigs').'000 -q long -R"select[mem>'.$self->o('blast_hm_gigs').'000] rusage[mem='.$self->o('blast_hm_gigs').'000]"', '-lifespan 1440' ]  },
